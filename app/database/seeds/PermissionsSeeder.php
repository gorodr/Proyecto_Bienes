<?php
    ...
    public function run()
    {
          $ver_real = new Permission();
    $ver_real->name = 'ver_real';
    $ver_real->display_name = 'ver bienes';
    $ver_real->save();
    ...
    $crear_roles = new Permission();
    $crear_roles->name = 'crear_real';
    $crear_roles->display_name = 'crear bienes';
    $crear_roles->save();
    ...
    $editar_roles = new Permission();
    $editar_roles->name = 'editar_real';
    $editar_roles->display_name = 'editar bienes';
    $editar_roles->save();
    ...
    $eliminar_roles = new Permission();
    $eliminar_roles->name = 'eliminar_real';
    $eliminar_roles->display_name = 'eliminar bienes';
    $eliminar_roles->save();
    }
